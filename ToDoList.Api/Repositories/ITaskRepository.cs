...
namespace ToDoList.Api.Repositories
{
    ...
    {
        public Task<List<TaskInfos>> GetAllTaskInfosAsync(int peopleId, int projectId);
        ...
        public Task<bool> CheckStatusTasks(int ownerId, int projectId);
        public void CheckExpiredTasks(List<Tasks> tasks);
